...
-- UPDATED TRAIT MAP - ALL TRAITS WITH CORRECT MULTIPLIERS
local traitMap = {
    -- S-Tier Traits (6x+)
    ["rbxassetid://84731118566493"] = {name = "Strawberry", mult = 9},
    ["rbxassetid://114748221761549"] = {name = "Meowl", mult = 8},
    ["rbxassetid://112821854659961"] = {name = "Rainbow Balloon", mult = 7.5},
    ["rbxassetid://133939661230277"] = {name = "Pink Egg", mult = 7.7},
    ["rbxassetid://117176397136731"] = {name = "John Pork", mult = 7.2},
    ["rbxassetid://83384385019272"] = {name = "Skibidi", mult = 7},
    ["rbxassetid://73467619616299"] = {name = "Granny", mult = 6.5},
    ["rbxassetid://114128099162490"] = {name = "Pink Balloon", mult = 6.5},
    ["rbxassetid://70894779883038"] = {name = "Reindeer Pet", mult = 6},
    ["rbxassetid://80468035315420"] = {name = "2G", mult = 6},
    ["rbxassetid://98316436141359"] = {name = "Halo", mult = 6},
    ["rbxassetid://124098467754457"] = {name = "Lucky", mult = 6},
    ["rbxassetid://119661964026012"] = {name = "Red Balloon", mult = 6},
    ["rbxassetid://119591742504251"] = {name = "Paint", mult = 6},
    ["rbxassetid://75650816341229"] = {name = "Brazil", mult = 6},
    ["rbxassetid://135489065859287"] = {name = "Rose", mult = 6},
    ["rbxassetid://118283346037788"] = {name = "Fire", mult = 6},
    ["rbxassetid://139729696247144"] = {name = "Lightning", mult = 6},
    ["rbxassetid://104229924295526"] = {name = "Nyan", mult = 6},
    ["rbxassetid://121100427764858"] = {name = "Fireworks", mult = 6},
    
    -- A-Tier Traits (4.5x-5.9x)
    ["rbxassetid://81641382604997"] = {name = "Chocolate", mult = 5.5},
    ["rbxassetid://97054765273857"] = {name = "Jackolantern Pet", mult = 5.5},
    ["rbxassetid://118516289496954"] = {name = "Bunny Ears", mult = 5.5},
    ["rbxassetid://109212886335786"] = {name = "Blue Egg", mult = 5.5},
    ["rbxassetid://108293878529172"] = {name = ":3", mult = 5.5},
    ["rbxassetid://88375043733582"] = {name = "Santa Hat", mult = 5},
    ["rbxassetid://93350414974589"] = {name = "Indonesia", mult = 5},
    ["rbxassetid://95128039793845"] = {name = "Sombrero", mult = 5},
    ["rbxassetid://82620342632406"] = {name = "Disco", mult = 5},
    ["rbxassetid://128841931686463"] = {name = "Blue Balloon", mult = 5},
    ["rbxassetid://94602857440295"] = {name = "Green Egg", mult = 5},
    ["rbxassetid://110723387483939"] = {name = "Zombie", mult = 5},
    ["rbxassetid://104964195846833"] = {name = "Claws", mult = 5},
    ["rbxassetid://121332433272976"] = {name = "Glitched", mult = 5},
    ["rbxassetid://103610037004911"] = {name = "Tie", mult = 4.75},
    ["rbxassetid://123115843719383"] = {name = "RIP Gravestone", mult = 4.5},
    ["rbxassetid://117478971325696"] = {name = "Spider", mult = 4.5},
    ["rbxassetid://115664804212096"] = {name = "Matteo Hat", mult = 4.5},
    ["rbxassetid://75222826429094"] = {name = "Green Balloon", mult = 4.5},
    
    -- B-Tier Traits (3x-4.4x)
    ["rbxassetid://123964048606874"] = {name = "Witch Hat", mult = 4},
    ["rbxassetid://89591838221335"] = {name = "Skeleton", mult = 4},
    ["rbxassetid://134655415681926"] = {name = "10B", mult = 4},
    ["rbxassetid://83111173051279"] = {name = "Orange Balloon", mult = 4},
    ["rbxassetid://99181785766598"] = {name = "Galactic", mult = 4},
    ["rbxassetid://97725744252608"] = {name = "Explosive", mult = 4},
    ["rbxassetid://104985313532149"] = {name = "Shark Fin", mult = 4},
    ["rbxassetid://76307362192037"] = {name = "Orange Egg", mult = 4},
    ["rbxassetid://100601425541874"] = {name = "Bubblegum", mult = 4},
    ["rbxassetid://127455440418221"] = {name = "Cometstruck", mult = 3.5},
    ["rbxassetid://89041930759464"] = {name = "Taco", mult = 3},
    ["rbxassetid://110910518481052"] = {name = "UFO", mult = 3},
    ["rbxassetid://83627475909869"] = {name = "Snowy", mult = 3},
    
    -- C-Tier Traits (0.5x-2.9x)
    ["rbxassetid://78474194088770"] = {name = "Wet", mult = 2.5},
    ["rbxassetid://115001117876534"] = {name = "Sleepy", mult = 0.5},
}

-- UPDATED MUTATION MAP - ALL MUTATIONS WITH CORRECT MULTIPLIERS
local mutationMap = {
    ["Gold"] = {mult = 1.25, displayText = "Gold", richText = "<font color=\"#FFDE59\">Gold</font>", color = Color3.fromRGB(255, 222, 89), icon = "rbxassetid://136133057822407"},
    ["Diamond"] = {mult = 1.5, displayText = "Diamond", richText = "<font color=\"#25C4FE\">Diamond</font>", color = Color3.fromRGB(37, 196, 254), icon = "rbxassetid://100875709547015"},
    ["Bloodrot"] = {mult = 2.5, displayText = "Bloodrot", richText = "<font color=\"#8A3B3C\">Bloodrot</font>", color = Color3.fromRGB(145, 0, 27), icon = "rbxassetid://75212036784031"},
    ["Rainbow"] = {mult = 10, displayText = "Rainbow", richText = "<font color=\"#ff00fb\">Rainbow</font>", color = Color3.fromRGB(255, 0, 251), icon = "rbxassetid://83078714090192"},
    ["Candy"] = {mult = 4, displayText = "Candy", richText = "<font color=\"#ff46f6\">Candy</font>", color = Color3.fromRGB(255, 70, 246), icon = "rbxassetid://84797673698685"},
    ["Lava"] = {mult = 6, displayText = "Lava", richText = "<font color=\"#ff7700\">Lava</font>", color = Color3.fromRGB(255, 149, 0), icon = "rbxassetid://70800471498231"},
    ["Galaxy"] = {mult = 7, displayText = "Galaxy", richText = "<font color=\"#aa3cff\">Galaxy</font>", color = Color3.fromRGB(170, 60, 255), icon = "rbxassetid://139331671405138"},
    ["Yin Yang"] = {mult = 7.5, displayText = "Yin Yang", richText = "<stroke color=\"#fff\" thickness=\"2\"><font color=\"#000\">Yin</font></stroke> <stroke color=\"#000\" thickness=\"2\"><font color=\"#fff\">Yang</font></stroke>", useRichText = true, color = Color3.fromRGB(255, 255, 255), icon = "rbxassetid://112996178302302"},
    ["YinYang"] = {mult = 7.5, displayText = "Yin Yang", richText = "<stroke color=\"#fff\" thickness=\"2\"><font color=\"#000\">Yin</font></stroke> <stroke color=\"#000\" thickness=\"2\"><font color=\"#fff\">Yang</font></stroke>", useRichText = true, color = Color3.fromRGB(255, 255, 255), icon = "rbxassetid://112996178302302"},
    ["Radioactive"] = {mult = 8.5, displayText = "Radioactive", richText = "<font color=\"#68f500\">Radioactive</font>", color = Color3.fromRGB(104, 245, 0), icon = "rbxassetid://134809510446754"},
    ["Cursed"] = {mult = 9, displayText = "Cursed", richText = "<font color=\"#9d00ff\">Cursed</font>", color = Color3.fromRGB(157, 0, 255), icon = "rbxassetid://139160534192980"},
    ["Divine"] = {mult = 10, displayText = "Divine", richText = "<font color=\"#ffeb3b\">Divine</font>", color = Color3.fromRGB(255, 235, 59), icon = "rbxassetid://117437279650650"},
    ["Cyber"] = {mult = 11, displayText = "Cyber", richText = "<font color=\"#00ffff\">Cyber</font>", color = Color3.fromRGB(0, 255, 255), icon = "rbxassetid://91596580591665"},
}
    ...
    if MutationsData then
        ...
        if success and mutationModule then
            ...
            if mutationInfo and mutationInfo.Palettes then
                -- Pick a random palette (game picks one randomly)
                local paletteIndex = math.random(1, #mutationInfo.Palettes)
                local palette = mutationInfo.Palettes[paletteIndex]
                
                if palette and #palette > 0 then
                    -- Skip hidden/invisible parts (game never colors these)
                    local skipParts = {
                        ["RootPart"] = true,
                        ["FakeRootPart"] = true,
                        ["VfxInstance"] = true,
                    ...
                    -- Collect only visible parts
                    local parts = {}
                    for _, part in ipairs(clonedAnimal:GetDescendants()) do
                        if (part:IsA("BasePart") or part:IsA("MeshPart")) and not skipParts[part.Name] then
                    ...
                    -- Apply palette colors to parts in order
                    for i, part in ipairs(parts) do
                        local colorIndex = ((i - 1) % #palette) + 1
                        local color = palette[colorIndex]
                        
                        if color then
                            part.Color = color
                            
                            -- Cyber mutation: Glass material + transparency
                            if mutationName == "Cyber" then
                                if color.R < 0.1 and color.G < 0.1 and color.B < 0.1 then
                                    part.Material = Enum.Material.Glass
                                    part.Transparency = 0.25
                                elseif color.R < 0.05 and color.G < 0.4 and color.B < 0.5 then
                                    part.Material = Enum.Material.Glass
                    ...
                    if mutationInfo.GradientPreset == "Rainbow" then
                        task.spawn(function()
                            local cycleIndex = 0
                            while clonedAnimal and clonedAnimal.Parent do
                                ...
                                for i, part in ipairs(parts) do
                                    if part and part.Parent then
                                        local colorIndex = ((i - 1 + cycleIndex) % #palette) + 1
...
local function spawnAnimal(animalName, selectedTraits, selectedMutation)
    ...
    -- FIXED TRAIT SPAWNING WITH PROPER WELDING
    if selectedTraits and clonedAnimal.PrimaryPart then
        ...
        for _, traitName in ipairs(selectedTraits) do
            ...
            -- FIXED: Model traits (physical models like hats, accessories)
                ...
                if traitModel then
                    ...
                    if traitClone:IsA("Model") then
                        ...
                        if customPlacement then
                            ...
                            -- Default: attach to animal's head if available
                            local head = clonedAnimal:FindFirstChild("Head") or clonedAnimal.PrimaryPart
                            if head then
                                traitClone:PivotTo(head.CFrame * CFrame.new(0, 2, 0)) -- 2 studs above head
                        ...
                        for _, part in ipairs(traitClone:GetDescendants()) do
                            if part:IsA("BasePart") then
                                ...
                                weld.Part0 = clonedAnimal.PrimaryPart or clonedAnimal:FindFirstChild("Head")
                                weld.Part1 = part
                                weld.Parent = part
                    ...
                    elseif traitClone:IsA("BasePart") then
                        if customPlacement and customPlacement:IsA("BasePart") then
                            ...
                            local head = clonedAnimal:FindFirstChild("Head") or clonedAnimal.PrimaryPart
                            if head then
                                traitClone.CFrame = head.CFrame * CFrame.new(0, 2, 0)
                            else
...
local function createNotification(title, description, duration, iconId)
    ...
    iconId = iconId or "rbxassetid://10747359646"
...
local discordInvite = "https://discord.gg/SnXQCYzGjx"

DiscordSection:CreateButton("Copy Discord Invite", function()
    setclipboard(discordInvite)
    createNotification("Discord Invite Copied!", "Join the best scripts discord server!\nInstant Steal, de-sync, dupe & more.", 6, "rbxassetid://10747359646")
end)
