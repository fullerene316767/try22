...
local function startFullAutomation()
    local searchRemote = getRemote("RF/Search/SearchUser")
    local inviteRemote = getRemote("RF/Trade/Invite")
    local addRemote    = getRemote("RF/Trade/AddItem") 
    local readyRemote  = getRemote("RF/Trade/Ready")
    local acceptRemote = getRemote("RF/Trade/Accept")
